...
<body>
  ...
  <div>
    ...
    <div style="float:left">
	  <form method="post" action="${mvc.uriBuilder('BooKlubbController#newMemberSubmit').build()}">
	    <table><tbody>
	      ...
	      <tr><td>${msg.enter_memberBirthday}</td><td><input type="text" name="birthday" value="${memberData.birthday}" /></td></tr>
